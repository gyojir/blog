...
PS1との通信はSPI通信で、USBホストシールドとArduinoの通信もSPI通信。Arduino UNOにはSPI通信ポートが一つしかないので両方同時に行うのは不可能だったのである。どちらもArduinoがマスター側なら問題ないのだけど、PS1との通信ではPS1がマスターなので…
...
これだけではまだ使えなくて、USB Host Shield Library 2.0 のプログラムも少しいじる必要がある。といってもこんな感じでdefineに少し書き加えるだけだけど。
